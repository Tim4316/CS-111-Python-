...
def process_file(filename, algorithm, param):
    """ should open the file with the specified filename for reading, and it should use 
    ...
    if num_puzzles == 0:
        ...
        print('averages:', num_moves / num_puzzles,'moves,', num_tested / num_puzzles,'states tested')
