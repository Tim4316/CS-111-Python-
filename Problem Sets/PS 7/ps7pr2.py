...
class Rectangle:
    def __init__(self, init_width, init_height, c):
    ...
    def diagonal(self):
        """ returns the length of the called Rectangle object’s diagonal """
        return math.sqrt((self.width ** 2) + (self.height ** 2))
    
    def larger_than(self, other):
        """ returns True if the called Rectangle object (the object given by self)
            has a larger area than the area of the Rectangle passed in for other, 
            and False otherwise """
